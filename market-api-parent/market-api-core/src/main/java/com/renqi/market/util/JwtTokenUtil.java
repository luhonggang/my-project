...
public class JwtTokenUtil {
     ...
     * 进行数字签名的私钥
     */
    private static final String APP_KEY = "www.renqi.market";
...
//    }
    ...
    public static void checkTokenIsExpiredTime(String jwtToken) throws HandleTokenException {
        try {
            ...
            e.printStackTrace();
            throw new HandleTokenException(e.getMessage(), SystemCode.EXPIRED_TOKEN.getCode(), SystemCode.EXPIRED_TOKEN.getMsg());
        }
    }
